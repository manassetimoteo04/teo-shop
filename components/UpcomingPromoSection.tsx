  ...
  return (
    <section className="max-w-[120rem] m-[16rem_auto]">
      <div className="grid grid-cols-2 gap-[4rem]">
        ...
        <div className="bg-gray-100 max-h-[40rem] p-[5rem] rounded-3xl flex items-center justify-center overflow-hidden">
          <img src="/products/apple-tv-4k-wifi.png" className="h-full w-auto" />
        </div>
      </div>
    </section>
  );
